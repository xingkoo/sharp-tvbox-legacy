            ...
            if (socket != null) {
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    List<String> allowedCiphers = Arrays.asList(
                            ...
                            // Several currently reachable VOD APIs negotiate TLS 1.2 only
                            // when the ChaCha20 ECDHE suites are offered. Conscrypt 2.5.2
                            // supports these on Android 4.4; the previous allow-list omitted
                            // them, causing a server-side handshake rejection.
